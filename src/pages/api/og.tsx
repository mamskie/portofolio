...
const regularFont = Promise.resolve(
  readFileSync(join(process.cwd(), 'public/assets/inter-regular.ttf'))
);
const mediumFont = Promise.resolve(
  readFileSync(join(process.cwd(), 'public/assets/inter-medium.ttf'))
);
